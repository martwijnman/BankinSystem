...
<header>
    ...
    <form style="display: flex; justify-content: center; padding: 10%;" action="controller.php" method="post">
  <fieldset disabled style="width: 500px;">
    <input type="hidden" name="action" value="add">
    <legend>Add your stock</legend>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">Name</label>
      <input type="text" name="title" id="disabledTextInput" class="form-control" placeholder="Disabled input">
    </div>
    <div class="mb-3">
    <label for="stockCategory" class="form-label">Your stock category</label>
    <select id="stockCategory" class="form-select" name="stock_category" required>
        <option value="" disabled selected>Choose</option>
        <option value="stocks">Stocks</option>
        <option value="otherinvests">Other Investments</option>
    </select>
</div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">price</label>
      <input type="text" name="price" id="disabledTextInput" class="form-control" placeholder="Disabled input">
    </div>

    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">user</label>
      <input type="text" name="user" id="disabledTextInput" class="form-control" placeholder="Disabled input">
    </div>
